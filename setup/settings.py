...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-key-default')

BARBERSHOP_NAME = os.getenv('BARBERSHOP_NAME', 'Barbearia do Mineiro')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.barbearia_config',
            ],
        },
    },
]
...
# Email settings (Placeholder for Reset)
